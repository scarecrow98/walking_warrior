...
//                    }
				...
				me.canMove = true;
                          ...
                          if (me.switches==true){
                           ...
                           if (me.lort==true){
                                    ...
                                    this.game.state.start("NextLevelStep");
                                }
	...
	createScore: function(){
		...
		me.scoreLabel = me.game.add.text(900, 1780, "0", {font: scoreFont, fill: "#ff2800"}); 
		...
		var scoreFont = "100px Arial";
                ...
                me.textLabel2 = me.game.add.text(1230, 240, "0", {font: textFont, fill: "#ff2800"});
                me.textLabel2.text = "Level: 3";
